...
var SwiperItemInner = /*#__PURE__*/function (_React$Component) {
  _inherits(SwiperItemInner, _React$Component);
  var _super = _createSuper(SwiperItemInner);
  function SwiperItemInner() {
    _classCallCheck(this, SwiperItemInner);
    return _super.apply(this, arguments);
  }
  _createClass(SwiperItemInner, [{
    key: "render",
  ...
  return SwiperItemInner;
}(React.Component);
var SwiperInner = /*#__PURE__*/function (_React$Component2) {
  _inherits(SwiperInner, _React$Component2);
  var _super2 = _createSuper(SwiperInner);
  function SwiperInner() {
    var _this;
    _classCallCheck(this, SwiperInner);
...
var SwiperItem = createForwardRefComponent(SwiperItemInner);
var Swiper = createForwardRefComponent(SwiperInner);
