...
const DraggableSheet = /*@__PURE__*/ Vue.extend({
    render: createCommonRender('taro-draggable-sheet-core', [], defineCustomElementTaroDraggableSheetCore),
});
...
const GridBuilder = /*@__PURE__*/ Vue.extend({
    render: createCommonRender('taro-grid-builder-core', [], defineCustomElementTaroGridBuilderCore),
});
...
const ListBuilder = /*@__PURE__*/ Vue.extend({
    render: createCommonRender('taro-list-builder-core', [], defineCustomElementTaroListBuilderCore),
});
...
const NestedScrollBody = /*@__PURE__*/ Vue.extend({
    render: createCommonRender('taro-nested-scroll-body-core', [], defineCustomElementTaroNestedScrollBodyCore),
});
const NestedScrollHeader = /*@__PURE__*/ Vue.extend({
    render: createCommonRender('taro-nested-scroll-header-core', [], defineCustomElementTaroNestedScrollHeaderCore),
});
...
const OpenContainer = /*@__PURE__*/ Vue.extend({
    render: createCommonRender('taro-open-container-core', [], defineCustomElementTaroOpenContainerCore),
});
...
const Script = /*@__PURE__*/ Vue.extend({
    render: createCommonRender('taro-script-core', [], defineCustomElementTaroScriptCore),
});
...
const Span = /*@__PURE__*/ Vue.extend({
    render: createCommonRender('taro-span-core', [], defineCustomElementTaroSpanCore),
});
