...
class Page extends creator_1.default {
    ...
    fetchTemplates() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (helper_1.fs.existsSync(taroConfig)) {
                ...
                templateSource = this.conf.templateSource || helper_1.DEFAULT_TEMPLATE_SRC;
    ...
    write() {
        const { projectName, projectDir, template, pageName, isCustomTemplate, customTemplatePath } = this.conf;
        let templatePath;
        if (isCustomTemplate) {
